...
def ward_tree(X, *, connectivity=None, n_clusters=None, return_distance=False, affinity=None):
...
class AgglomerativeClustering(ClusterMixin, BaseEstimator):
    ...
    def _fit(self, X):
        ...
        #    raise ValueError(
        #        "%string was provided as affinity. Ward can only "
        ...
        # Changes here
        elif self.affinity in {"cityblock", "euclidean"}:
            kwargs["affinity"] = self.affinity
